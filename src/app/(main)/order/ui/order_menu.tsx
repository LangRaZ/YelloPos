...
export default function OrderMenu() {
  ...
  return (
    <div className="flex flex-row w-full">
      <div className="flex flex-col md:w-2/3 2xl:w-3/4 w-full md:pr-10 ">
        ...
        <div className="mt-2 flex flex-col gap-5 md:pb-0 pb-32">
          {(categories??[]).map((category, idx)=>(
            category.product_count != 0 && (
              <div key={idx} className="mt-2">
                <span id={`${category.category_name}`} className="font-medium text-xl mb-10">{category.category_name?.toUpperCase()}</span>
                <div className="grid 2xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-10 px-1 mt-4">
      ...
      <div className="h-[91vh] xl:w-1/3 2xl:w-1/4 md:w-1/2 md:flex hidden border-2 rounded-lg sticky top-[50px] z-10">
      ...
      <div className="md:hidden fixed inset-x-4 bottom-5 h-fit border rounded-lg border-gray-100 bg-white shadow-lg shadow-primary/20 z-50">
